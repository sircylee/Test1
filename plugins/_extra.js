...
smd({
  ...
  try {
    ...
    if (!_0x587b99) {
      return await _0x4cdec8.reply("*Need URL! Use " + prefix + "ss https://github.com/sircylee/Queen_Kylie-V1*");
    }
...
let tmpUrl = "https://files.catbox.moe/3irlh9.jpg";
const secmailData = {};
smd({
  pattern: "tempmail",
