const {
 ...
 smd({
   ...
   try {
     ...
     if (!_0x332d77) {
       return await _0x25d56b.reply("*Give Kylie a text to Update This Group Name* 👸❤️");
     }
 ...
 cmd({
   ...
   try {
     ...
     if (_0x37477b.length > 1) {
       ...
       return await _0x3a5b8e.send("Provide Kylie a Group Jid*👸❤️");
     }
     ...
     if (_0x4fbd42) {
       ...
       if (!_0x16096e) {
         _0x543a19 = "*❲❒❳ Reason:* You fool, 👸❤️Only Group Admin Can Kick Common Users Through This Cmd_\n";
       }
     }
 ...
 cmd({
   ...
   try {
     ...
     if (_0x53f916.length > 1) {
       ...
       return await _0x210433.send("Provide Kylie a Group Jid👸❤️");
     }
 ...
 cmd({
   ...
   try {
     ...
     if (!_0x8f9e68) {
       return await _0x324f8b.reply("*Reply/mention an User*👸❤️");
     }
 ...
 cmd({
   ...
   try {
     ...
     if (!_0x4e844a) {
       return await _0x5e533c.reply("*Reply/mention an User*👸❤️");
     }
 ...
 smd({
   ...
   try {
     ...
     if (!_0x48bdf1) {
       return await _0x378ec3.send("*Reply to message!!!_*👸❤️");
     }
 ...
 cmd({
   ...
   try {
     ...
     if (!_0x23d1da) {
       return await _0x3d5ec9.reply("*Provide a User for Kylie._*👸❤️");
     }
     try {
 ...
 cmd({
   ...
   try {
     ...
     if (!_0x3ce3f1) {
       return await _0x118677.reply("*Reply/mention an User*👸❤️");
     }
 ...
 cmd({
   ...
   try {
     if (!_0x5d14a3) {
       return await _0x553d05.reply("*Provide text to broadcast in all groups_*👸❤️");
     }
