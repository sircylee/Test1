...
smd(
    ...
    try {
      ...
      if (!repoUrl) {
        return await _0x1ae8f8.reply(
          "*Provide Repo URL, e.g., .git https://github.com/sircylee/Queen_Kylie-V1_*"
        );
      }
 ...
 smd({
   ...
   try {
     ...
     if (!_0x204f81) {
       return _0x55aba2.reply("*_Example : .tts Hi,I am Queen_Kylie-Md whatsapp bot._*");
     }
     try {
 ...
 smd({
   pattern: "sound",
    alias: ["KYLIEi", "aine","mentalism","alive","waso"],
 ...
 smd({
   ...
   try {
     ...
     try {
       ...
       let _0x4b47c3 = "./temp/KYLIE-Md " + _0x1d542b[1] + ".mp3";
     ...
     let _0x300d1a = {
       ...
       mimetype: "audio/mpeg",
       fileName: "KYLIE-Md--" + _0x1d542b[1] + ".mp3",
       caption: Config.caption,
